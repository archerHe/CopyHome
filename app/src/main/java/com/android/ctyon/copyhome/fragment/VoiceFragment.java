package com.android.ctyon.copyhome.fragment;
 ...
 */
public class VoiceFragment extends Fragment  implements MainView {
    ...
    public void cloudStartRecord(){
        presenter.startRecord();
    }

    public void cloudStopRecord(){
